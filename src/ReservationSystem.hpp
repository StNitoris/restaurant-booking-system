...
public:
    ...
    void restoreStatus(ReservationStatus status);
    void restoreTable(std::optional<int> tableId);
    void restoreLastModified(std::chrono::system_clock::time_point time);
...
public:
    ...
    void setNextReservationNumber(int next);
    void setNextOrderNumber(int next);
    int getNextReservationNumber() const;
    int getNextOrderNumber() const;
    void replaceState(std::string date,
